...
import com.example.notesminer.databinding.ActivityBtechOneBinding

class BtechOne : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding = ActivityBtechOneBinding.inflate(layoutInflater)
        setContentView(binding.root)
        val uri = "https://t.me/cgu_1st_year_cse_2019/2"
        fun gotosite() {
        ...
        val button6: Button = binding.button22
        button6.setOnClickListener {
            gotosite()
        }
        val button7: Button = binding.button23
